            ...
            >
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <button className='btn btn-xs md:btn-sm lg:px-8 absolute bottom-1 md:bottom-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>SHIRT</button>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='relative'>
                        <Image className='rounded-md' width={500} src={t_shirt} alt="" />
                        <button className='btn btn-xs md:btn-sm lg:px-8 absolute bottom-1 md:bottom-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>T-SHIRT</button>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='relative'>
                ...
                <SwiperSlide>
                    <div className='relative'>
                        ...
                        <button className='btn btn-xs md:btn-sm lg:px-8 absolute bottom-1 md:bottom-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>POLO</button>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
                    <div className='relative'>
                        <Image className='rounded-md' width={500} src={boxer} alt="" />
                        <button className='btn btn-xs md:btn-sm lg:px-8 absolute bottom-1 md:bottom-4 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>BOXER</button>
                    </div>
                </SwiperSlide>
            </Swiper>
        </div>
