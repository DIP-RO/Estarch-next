  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 lg:mx-24 gap-5 mt-10 mx-4">
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-end mb-5  justify-center text-white text-2xl font-semibold">
          <p className="font-bold bg-black bg-opacity-50 px-4 py-2 rounded">Printed Short Sleeve</p>
        </div>
      </div>
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-end mb-5  justify-center text-white text-2xl font-semibold">
          <p className="font-bold bg-black bg-opacity-50 px-4 py-2 rounded">Designer Edition</p>
        </div>
      </div>
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-end mb-5 justify-center text-white text-2xl font-semibold">
          <p className="font-bold bg-black bg-opacity-50 px-4 py-2 rounded">Short Sleeve Blanks</p>
        </div>
      </div>
    </div>
  );
