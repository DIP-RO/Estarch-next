    ...
    return (
        <div className='mx-12 mt-5'>
            ...
            <div className='flex justify-between items-center mb-4'>
                ...
                <label className="form-control w-full max-w-[10%] flex">
            ...
            <div className='grid grid-cols-12'>
                ...
                <div className='col-span-2 mr-8'>
                    ...
                    <hr className='border-2 border-orange-300 max-w-[25%]' />

                    {/* PRICE */}
                    <div>
                        <h1 className=' mt-4 text-gray-400'>PRICE</h1>
                        <hr className='border-2' />
                        <hr className='border-2 border-orange-300 max-w-[15%] mt-[-3px]' />
                        <div className='mt-2'>
                    ...
                    <div>
                        ...
                        <hr className='border-2' />
                        <hr className='border-2 border-orange-300 max-w-[12%] mt-[-3px]' />
                        <div className='mt-2'>
                            <div className="form-control">
                                <label className="label cursor-pointer flex justify-start gap-4">
                                    <input type="checkbox" className="checkbox checkbox-sm" />
                ...
                {/* Products */}
                <div className='col-span-10 gap-6 grid grid-cols-4'>
                    {products.map(product => (
                        <div key={product.id} className="card card-compact bg-base-100 shadow-xl h-[500px] ">
                            <figure>
